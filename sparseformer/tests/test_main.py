...
from sparseformer.ckpt_utils import convert_ckpt_v1_to_v2
from sparseformer.config import base_v1_config
...
if __name__ == "__main__":
    ...
    net = SparseFormer(**base_v1_config())
    net.eval()

    state_dict = torch.load("sparseformer_t_imagenet1k.pth")

...
def build_loader(config):
    ...
    if config.DATA.ZIP_MODE and config.DATA.CACHE_MODE == 'part':
        ...
        if config.DATA.REPEAT_AUG:
            print('USE Repeat Augmentation')
            sampler_train = RASampler(
                dataset_train, num_replicas=num_tasks, rank=global_rank, shuffle=True, batch_size=config.DATA.BATCH_SIZE, num_of_example=config.DATA.REPEAT_AUG_NUM)
        else:

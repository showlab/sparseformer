...
#
# Modifications:
# Ziteng Gao & Zhan Tong: adding support for SparseFormer 
# configurations
# --------------------------------------------------------'
...
_C.DATA.REPEAT_AUG = True
_C.DATA.REPEAT_AUG_NUM = 3
...
_C.SF = CN()
_C.SF.CONV_DIM = 96
_C.SF.NUM_LATENT_TOKENS = 49
_C.SF.TOKEN_SAMPLING_POINTS = 36
_C.SF.WIDTH_CONFIGURATIONS = [256, 512]
_C.SF.BLOCK_SIZES = [1, 8]
_C.SF.REPEATS = [4, 1]
_C.SF.DROP_PATH_RATE = 0.2
